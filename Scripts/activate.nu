...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'E:\Python\Telegram_Bots\aggregator_bot\aggregator_b'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'E:\Python\Telegram_Bots\aggregator_bot\aggregator_b\Scripts\deactivate.nu'
